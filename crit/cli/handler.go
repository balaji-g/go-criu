...
import (
	...
	"github.com/balajinvda/go-criu/v8/crit/images/apparmor"
	"github.com/balajinvda/go-criu/v8/crit/images/autofs"
	binfmt_misc "github.com/balajinvda/go-criu/v8/crit/images/binfmt-misc"
	bpfmap_data "github.com/balajinvda/go-criu/v8/crit/images/bpfmap-data"
	bpfmap_file "github.com/balajinvda/go-criu/v8/crit/images/bpfmap-file"
	"github.com/balajinvda/go-criu/v8/crit/images/cgroup"
	"github.com/balajinvda/go-criu/v8/crit/images/cpuinfo"
	"github.com/balajinvda/go-criu/v8/crit/images/creds"
	criu_core "github.com/balajinvda/go-criu/v8/crit/images/criu-core"
	criu_sa "github.com/balajinvda/go-criu/v8/crit/images/criu-sa"
	"github.com/balajinvda/go-criu/v8/crit/images/eventfd"
	"github.com/balajinvda/go-criu/v8/crit/images/eventpoll"
	ext_file "github.com/balajinvda/go-criu/v8/crit/images/ext-file"
	"github.com/balajinvda/go-criu/v8/crit/images/fdinfo"
	"github.com/balajinvda/go-criu/v8/crit/images/fh"
	"github.com/balajinvda/go-criu/v8/crit/images/fifo"
	file_lock "github.com/balajinvda/go-criu/v8/crit/images/file-lock"
	"github.com/balajinvda/go-criu/v8/crit/images/fs"
	"github.com/balajinvda/go-criu/v8/crit/images/fsnotify"
	"github.com/balajinvda/go-criu/v8/crit/images/inventory"
	ipc_msg "github.com/balajinvda/go-criu/v8/crit/images/ipc-msg"
	ipc_sem "github.com/balajinvda/go-criu/v8/crit/images/ipc-sem"
	ipc_shm "github.com/balajinvda/go-criu/v8/crit/images/ipc-shm"
	ipc_var "github.com/balajinvda/go-criu/v8/crit/images/ipc-var"
	"github.com/balajinvda/go-criu/v8/crit/images/memfd"
	"github.com/balajinvda/go-criu/v8/crit/images/mm"
	"github.com/balajinvda/go-criu/v8/crit/images/mnt"
	"github.com/balajinvda/go-criu/v8/crit/images/netdev"
	"github.com/balajinvda/go-criu/v8/crit/images/ns"
	packet_sock "github.com/balajinvda/go-criu/v8/crit/images/packet-sock"
	"github.com/balajinvda/go-criu/v8/crit/images/pidns"
	"github.com/balajinvda/go-criu/v8/crit/images/pipe"
	pipe_data "github.com/balajinvda/go-criu/v8/crit/images/pipe-data"
	"github.com/balajinvda/go-criu/v8/crit/images/pstree"
	"github.com/balajinvda/go-criu/v8/crit/images/regfile"
	remap_file_path "github.com/balajinvda/go-criu/v8/crit/images/remap-file-path"
	"github.com/balajinvda/go-criu/v8/crit/images/rlimit"
	"github.com/balajinvda/go-criu/v8/crit/images/seccomp"
	"github.com/balajinvda/go-criu/v8/crit/images/signalfd"
	sk_inet "github.com/balajinvda/go-criu/v8/crit/images/sk-inet"
	sk_netlink "github.com/balajinvda/go-criu/v8/crit/images/sk-netlink"
	sk_packet "github.com/balajinvda/go-criu/v8/crit/images/sk-packet"
	sk_unix "github.com/balajinvda/go-criu/v8/crit/images/sk-unix"
	"github.com/balajinvda/go-criu/v8/crit/images/stats"
	tcp_stream "github.com/balajinvda/go-criu/v8/crit/images/tcp-stream"
	"github.com/balajinvda/go-criu/v8/crit/images/timens"
	"github.com/balajinvda/go-criu/v8/crit/images/timer"
	"github.com/balajinvda/go-criu/v8/crit/images/timerfd"
	"github.com/balajinvda/go-criu/v8/crit/images/tty"
	"github.com/balajinvda/go-criu/v8/crit/images/tun"
	"github.com/balajinvda/go-criu/v8/crit/images/userns"
	"github.com/balajinvda/go-criu/v8/crit/images/utsns"
	"github.com/balajinvda/go-criu/v8/crit/images/vma"
