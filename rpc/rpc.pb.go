...
type CriuOpts struct {
	...
	Portable             *bool                  `protobuf:"varint,75,opt,name=portable" json:"portable,omitempty"`
	Stream               *bool                  `protobuf:"varint,76,opt,name=stream" json:"stream,omitempty"` //	optional bool			check_mounts		= 128;
}
...
var file_rpc_rpc_proto_rawDesc = []byte{
	...
	0x20, 0x02, 0x28, 0x0d, 0x52, 0x05, 0x69, 0x6e, 0x6f, 0x64, 0x65, 0x22, 0x90, 0x15, 0x0a, 0x09,
	...
	0x72, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x73, 0x74, 0x72, 0x65, 0x61, 0x6d,
	0x18, 0x4c, 0x20, 0x01, 0x28, 0x08, 0x52, 0x06, 0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x22, 0x2c,
	...
	0x54, 0x10, 0x06, 0x2a, 0x40, 0x0a, 0x18, 0x63, 0x72, 0x69, 0x75, 0x5f, 0x6e, 0x65, 0x74, 0x77,
	...
	0x08, 0x4e, 0x46, 0x54, 0x41, 0x42, 0x4c, 0x45, 0x53, 0x10, 0x02, 0x12, 0x08, 0x0a, 0x04, 0x53,
	0x4b, 0x49, 0x50, 0x10, 0x03, 0x2a, 0x2d, 0x0a, 0x12, 0x63, 0x72, 0x69, 0x75, 0x5f, 0x70, 0x72,
...
func file_rpc_rpc_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_rpc_rpc_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_rpc_rpc_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_rpc_rpc_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_rpc_rpc_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_rpc_rpc_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_rpc_rpc_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_rpc_rpc_proto_msgTypes[6].Exporter = func(v any, i int) any {
			switch v := v.(*UnixSk); i {
			case 0:
				return &v.state
			case 1:
		...
		file_rpc_rpc_proto_msgTypes[7].Exporter = func(v any, i int) any {
		...
		file_rpc_rpc_proto_msgTypes[8].Exporter = func(v any, i int) any {
		...
		file_rpc_rpc_proto_msgTypes[9].Exporter = func(v any, i int) any {
		...
		file_rpc_rpc_proto_msgTypes[10].Exporter = func(v any, i int) any {
		...
		file_rpc_rpc_proto_msgTypes[11].Exporter = func(v any, i int) any {
		...
		file_rpc_rpc_proto_msgTypes[12].Exporter = func(v any, i int) any {
		...
		file_rpc_rpc_proto_msgTypes[13].Exporter = func(v any, i int) any {
		...
		file_rpc_rpc_proto_msgTypes[14].Exporter = func(v any, i int) any {
